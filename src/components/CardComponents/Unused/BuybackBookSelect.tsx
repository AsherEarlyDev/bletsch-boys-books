...
export default function BuybackBookSelect(props:{saveFunction: any, defaultValue?:any, vendorId: string}) {
  // Saves the ISBN of the book selected no matter what option is chosen
  const books = api.books.getBooksByVendorId.useQuery({vendorId: props.vendorId}).data
