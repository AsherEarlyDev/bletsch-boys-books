...
export default function BookTableRow(props:BookTableRowProp) {
  ...
  return (
      <tr>
        ...
        <TableEntry width={16}>{props.bookInfo.inventory}</TableEntry>
        <TableEntry width={12}>{props.bookInfo.lastMonthSales}</TableEntry>
        ...
        <TableEntry width={12}>{(props.bookInfo.daysOfSupply == Infinity ? "Inf." : props.bookInfo.daysOfSupply )}</TableEntry>
